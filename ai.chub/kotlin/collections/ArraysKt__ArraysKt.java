        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m685contentEqualskV0jMPg(((UByteArray) t).m201unboximpl(), ((UByteArray) t2).m201unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m683contentEqualsFGO6Aew(((UShortArray) t).m464unboximpl(), ((UShortArray) t2).m464unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m684contentEqualsKJPZfPQ(((UIntArray) t).m280unboximpl(), ((UIntArray) t2).m280unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m686contentEqualslec5QzE(((ULongArray) t).m359unboximpl(), ((ULongArray) t2).m359unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m691contentToString2csIQuQ(uByteArray != null ? uByteArray.m201unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m693contentToStringd6D3K8(uShortArray != null ? uShortArray.m464unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m692contentToStringXUkPCBk(uIntArray != null ? uIntArray.m280unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m694contentToStringuLth9ew(uLongArray != null ? uLongArray.m359unboximpl() : null));
            } else {
