...
public final class Route {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = AuthorizationRequest.Scope.ADDRESS, imports = {}))
    /* renamed from: -deprecated_address  reason: not valid java name */
    public final Address m1812deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m1813deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m1814deprecated_socketAddress() {
        return this.socketAddress;
    }
