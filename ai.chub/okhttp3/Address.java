...
public final class Address {
    ...
    public final HttpUrl m1692deprecated_url() {
        return this.url;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "dns", imports = {}))
    /* renamed from: -deprecated_dns  reason: not valid java name */
    public final Dns m1684deprecated_dns() {
        return this.dns;
    }
    ...
    public final Authenticator m1688deprecated_proxyAuthenticator() {
        return this.proxyAuthenticator;
    }
    ...
    public final List<ConnectionSpec> m1683deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
