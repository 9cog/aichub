...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1730deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m1732deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m1731deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Removed duplicated region for block: B:23:0x006c A[LOOP:0: B:3:0x0006->B:23:0x006c, LOOP_END] */
                ...
                if (charAt != '\t') {
                    if (!(' ' <= charAt && charAt < 127)) {
                        ...
                        if (z) {
                            ...
                            sb.append(Util.isSensitiveHeader(str2) ? HttpUrl.FRAGMENT_ENCODE_SET : ": " + str);
