...
public class PluginResult {
    ...
    PluginResult jsonPut(String str, Object obj) {
        try {
            ...
            Logger.error(Logger.tags("Plugin"), HttpUrl.FRAGMENT_ENCODE_SET, e);
        }
        return this;
    }
    ...
    public JSObject getWrappedResult() {
        ...
        jSObject.put(AuthorizationException.PARAM_ERROR, (Object) this.json.getJSObject(AuthorizationException.PARAM_ERROR));
        return jSObject;
    }
}
