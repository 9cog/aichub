...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m50lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m51lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    public /* synthetic */ void m52lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m53lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
