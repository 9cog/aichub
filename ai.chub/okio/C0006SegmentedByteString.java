...
public final class C0006SegmentedByteString extends ByteString {
    ...
    public C0006SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0006SegmentedByteString c0006SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0006SegmentedByteString, i2);
        if (!(i >= 0)) {
        ...
        if (!(i3 >= 0)) {
            ...
            return c0006SegmentedByteString;
        } else {
