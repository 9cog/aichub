    ...
    public long readDecimalLong() throws EOFException {
        ...
        loop0: while (true) {
            ...
            while (i2 < i3) {
                ...
                if (b >= 48 && b <= 57) {
                    int i4 = 48 - b;
                    int i5 = (j > okio.internal.Buffer.OVERFLOW_ZONE ? 1 : (j == okio.internal.Buffer.OVERFLOW_ZONE ? 0 : -1));
                    if (i5 < 0 || (i5 == 0 && i4 < j2)) {
                        break loop0;
                    }
                    j = (j * 10) + i4;
