...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m118exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m118exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m118exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m118exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m118exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
