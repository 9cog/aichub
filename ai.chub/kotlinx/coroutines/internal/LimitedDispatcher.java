...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1670scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo1670scheduleResumeAfterDelay(j, cancellableContinuation);
    }
    ...
    */
            ...
            while (true) {
                ...
                if (i >= 16) {
                    ...
                    if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                        this.dispatcher.mo1669dispatch(limitedDispatcher, this);
                        return;
                    }
                }
            }
    ...
    public void mo1669dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.dispatcher.mo1669dispatch(this, this);
    }
