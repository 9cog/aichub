...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m115constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m115constructorimpl(ResultKt.createFailure(th));
        }
        ...
        try {
            ...
            obj2 = Result.m115constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m115constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m118exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
