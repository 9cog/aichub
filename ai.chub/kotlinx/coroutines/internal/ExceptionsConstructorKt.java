...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m115constructorimpl = Result.m115constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            try {
                                ...
                                Result.Companion companion2 = Result.Companion;
                                m115constructorimpl = Result.m115constructorimpl(ResultKt.createFailure(th2));
                            }
                            if (newInstance != null) {
                                m115constructorimpl = Result.m115constructorimpl((Throwable) newInstance);
                                if (Result.m121isFailureimpl(m115constructorimpl)) {
                                    m115constructorimpl = null;
                                }
                                return (Throwable) m115constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m115constructorimpl = Result.m115constructorimpl(th3);
                                if (Result.m121isFailureimpl(m115constructorimpl)) {
                                    m115constructorimpl = null;
                                }
                                return (Throwable) m115constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m115constructorimpl = Result.m115constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m115constructorimpl = Result.m115constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m115constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m115constructorimpl = Result.m115constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m115constructorimpl = Result.m115constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m121isFailureimpl(m115constructorimpl)) {
            m115constructorimpl = valueOf;
        }
        return ((Number) m115constructorimpl).intValue();
    }
