            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1621receiveCatchingJP2dKIU = receiveChannel.mo1621receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m1633getOrNullimpl(mo1621receiveCatchingJP2dKIU);
                }
            }
