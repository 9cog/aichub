...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1621receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        return pollInternal instanceof Closed ? ChannelResult.Companion.m1641closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1643successJP2dKIU(pollInternal);
                    }
                ...
                return ((ChannelResult) obj).m1640unboximpl();
            }
        }
        ...
        return ((ChannelResult) obj2).m1640unboximpl();
    }
    ...
    public final Object mo1622tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1642failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1641closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1643successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m1660constructorimpl$default = InlineList.m1660constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1668remove()) {
                    prevNode.helpRemove();
                } else {
                    m1660constructorimpl$default = InlineList.m1665plusFjFbRPM(m1660constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1620onCancelIdempotentListww6eGU(m1660constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1628boximpl(z ? companion.m1641closedJP2dKIU(((Closed) obj).closeCause) : companion.m1643successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            throw StackTraceRecoveryKt.recoverStackTrace(((Closed) obj).getReceiveException());
        } else {
            if (i == 1 && selectInstance.trySelect()) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1628boximpl(ChannelResult.Companion.m1641closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m115constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m115constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1628boximpl(ChannelResult.Companion.m1643successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m115constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m1628boximpl = ChannelResult.m1628boximpl(ChannelResult.Companion.m1641closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m115constructorimpl(m1628boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1628boximpl(ChannelResult.Companion.m1643successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1628boximpl(ChannelResult.Companion.m1641closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1620onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
