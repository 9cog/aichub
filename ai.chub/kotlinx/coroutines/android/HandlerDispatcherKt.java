...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m115constructorimpl = Result.m115constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m115constructorimpl = Result.m115constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m121isFailureimpl(m115constructorimpl) ? null : m115constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1669dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void m1619postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
