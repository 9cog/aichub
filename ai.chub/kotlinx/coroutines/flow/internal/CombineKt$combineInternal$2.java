...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, d2 = {"<anonymous>", HttpUrl.FRAGMENT_ENCODE_SET, "R", "T", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 6, 0}, xi = 48)
...
final class CombineKt$combineInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x00eb A[LOOP:0: B:28:0x00eb->B:34:0x010e, LOOP_START, PHI: r6 r10 
      PHI: (r6v7 int) = (r6v6 int), (r6v8 int) binds: [B:25:0x00e6, B:34:0x010e] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r10v8 kotlin.collections.IndexedValue) = (r10v7 kotlin.collections.IndexedValue), (r10v21 kotlin.collections.IndexedValue) binds: [B:25:0x00e6, B:34:0x010e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:41:0x0133 -> B:20:0x00c5). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:47:0x0166 -> B:45:0x0162). Please submit an issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            ResultKt.throwOnFailure(obj);
            obj2 = ((ChannelResult) obj).m1640unboximpl();
            b2 = r2;
            bArr = (byte[]) this.L$2;
            channel = (Channel) this.L$1;
            combineKt$combineInternal$2 = this;
            indexedValue = (IndexedValue) ChannelResult.m1633getOrNullimpl(obj2);
            ...
            do {
                ...
                bArr[index] = b2;
                indexedValue = (IndexedValue) ChannelResult.m1633getOrNullimpl(channel.mo1622tryReceivePtdJZtk());
        ...
        obj2 = channel.mo1621receiveCatchingJP2dKIU(combineKt$combineInternal$2);
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    int i2 = this.$i;
                    this.label = 1;
                    if (flowArr[i2].collect(new C00031(this.$resultChannel, i2), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* compiled from: Combine.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", HttpUrl.FRAGMENT_ENCODE_SET, "R", "T", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 6, 0}, xi = 48)
