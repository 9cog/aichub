    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            public static final class C00041 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    Object mo1621receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo1621receiveCatchingJP2dKIU = this.$second.mo1621receiveCatchingJP2dKIU(this);
                        if (mo1621receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else if (i != 1) {
                        if (i != 2) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo1621receiveCatchingJP2dKIU = ((ChannelResult) obj).m1640unboximpl();
                    }
                    FlowCollector flowCollector2 = this.$this_unsafeFlow;
                    if (mo1621receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m1632exceptionOrNullimpl = ChannelResult.m1632exceptionOrNullimpl(mo1621receiveCatchingJP2dKIU);
                    ...
                    T1 t1 = this.$value;
                    if (mo1621receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo1621receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector2;
                    this.label = 2;
                    obj = function3.invoke(t1, mo1621receiveCatchingJP2dKIU, this);
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            if (ChannelFlowKt.withContextUndispatched(this.$scopeContext, Unit.INSTANCE, this.$cnt, new C00041(this.$second, this.$this_unsafeFlow, this.$transform, t1, null), combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else if (i != 1) {
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
