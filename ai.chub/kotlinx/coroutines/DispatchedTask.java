        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m115constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m115constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m115constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m115constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m115constructorimpl2 = Result.m115constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m115constructorimpl2 = Result.m115constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m118exceptionOrNullimpl(m115constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m115constructorimpl = Result.m115constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m118exceptionOrNullimpl(m115constructorimpl));
        }
    }
