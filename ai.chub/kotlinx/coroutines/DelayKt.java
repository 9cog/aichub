...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1670scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1605delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1606toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1606toDelayMillisLRDsOJo(long j) {
        if (Duration.m1440compareToLRDsOJo(j, Duration.Companion.m1544getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1459getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
